    ...
    <>
      <div id="mainContainerCSU">
          ...
          <div className="containerInsertInfo">
            <div className="insertInfo">
              ...
              {isEditing ? (
                ...
                <p className="optionInfo" id="name">{name}</p>
              )}
            </div>
            <div className="insertInfo">
              <h3>E-MAIL</h3>
              {isEditing ? (
                ...
                <p className="optionInfo" id="email">{email}</p>
              )}
            </div>
          </div>
          ...
          <div className="containerInsertInfo">
            <div className="insertInfo">
              ...
              {isEditing ? (
                ...
                <p className="optionInfo" id="idade">{age}</p>
              )}
            </div>
            <div className="insertInfo">
              <h3>CARGO</h3>
              {isEditing ? (
                ...
                <p className="optionInfo" id="function">{internalFunction}</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="insertInfo" id="sendInfo">
          {isEditing ? (
            <button onClick={handleSaveClick}><span className="material-symbols-outlined">save</span></button>
          ) : (
            <button onClick={handleEditClick}><span className="material-symbols-outlined">edit</span></button>
          )}
